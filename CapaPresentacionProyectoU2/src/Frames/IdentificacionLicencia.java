 ...
 * @author Arell
 */
public class IdentificacionLicencia extends javax.swing.JFrame {

    /**
     * Creates new form IdentificacionLicencia
     */
    public IdentificacionLicencia() {
           initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IdentificacionLicencia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IdentificacionLicencia().setVisible(true);
            }
        });
    }
